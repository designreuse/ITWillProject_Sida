...
<div class="header">
    <div class="col-md-12">
        <h3 class="header-title">Charts</h3>
        <p class="header-info">Make your reports stand out and engage your users</p>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel ">
                ...
                <div class="panel-body">
                    <div>
                        <div id="realTime" class="chart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel ">
                <div class="panel-heading">
                    <h3 class="panel-title">Zoom Chart</h3>
                </div>
                <div class="panel-body">
                    <div id="chartZoom" class="chart"></div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div class="panel ">
                <div class="panel-heading">
                    <h3 class="panel-title">Horizontal Chart</h3>
                </div>
                <div class="panel-body">
                    <div>
                        <div id="horizontal" class="chart"></div>
                    </div>
                </div>
            </div>
        </div>
