...
<script>
	...
	//추가 flag와 onchange, c:choose를 통한 코드를 짜보려고 했으나, html코드가 너무 지저분해지므로 이미지삽입작업폼과 수정작업폼을 분리하는게 좋을것같다.
</script>
<meta charset="utf-8" />
...
<body style="margin-left: 5%; margin-right: 5%;">
	<h3>Modifying</h3>
	<!-- ad_imageModify구현중!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
	<form class="form-horizontal" role="form" action="ad_imageModify"
		enctype="multipart/form-data" method="post" name="imageModifyForm">
		...
		<div class="main-content">
			<div class="row">
				...
				<c:choose>
					<c:when test="${addressBook.ad_image==null}">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							...
							<div>
								<span class="btn btn-info btn-file"> <span
									...
									name="userImg" id="uploadFile" onchange="submit();">
					...
					<c:otherwise>
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-new thumbnail"
								style="width: 140px; height: 140px;">
								<img src="getAddressBookImage/${addressBook.ad_no }" alt=""
									class="img-circle" style="width: 140px; height: 140px;" /><br />
							</div>
							<div class="fileinput-preview fileinput-exists thumbnail"
								style="max-width: 200px; max-height: 150px;"></div>
							...
							<div>
								<!--
					기존의 설정은 파일을 서버단의 있는 파일을 editform페이지로 다시 불러와서 다시 삽입하려고 시도했다. 
					<input type=file>이 read-only인 것은 심각한 보안문제때문이므로 삽입을 하는걸 비추한다. 스크립트로 innerHTML로 수정은 가능하다.
					이 문제를 해결하기위해서, text의 수정과 image의 수정을 분리하는것이 가장 안정적인것같다.
					 -->
								<span class="btn btn-info btn-file"> <span
									class="fileinput-new">Select image</span> <span
									class="fileinput-exists">Change</span> <input type="file"
						...
						<div class="row-span">
							<div class="col-sm-10" style="margin-bottom: 8px;">
								<input type="text" placeholder="Email"
									value="${addressBook.ad_email }" name="email">
							</div>
						</div>
