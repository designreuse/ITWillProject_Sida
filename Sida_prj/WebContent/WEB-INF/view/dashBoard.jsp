...
<!-- CONTENT -->
                ...
                <div class="panel-body">
                    <ul class="col-md-12 stats">
                        <li class="stat col-md-3 col-sm-3 col-xs-6">
                            <span><b class="value"><i class="fa fa-fw fa-krw" style="font-size: 12px;"></i><fmt:formatNumber value="${moneyUsedMap.todayUsedTotal }" type="number"/> <br></b> Daily </span>
                            <em>Total</em>
                        </li>
                        <li class="stat col-md-3 col-sm-3 col-xs-6">
                            <span><b class="value"><i class="fa fa-fw fa-krw" style="font-size: 12px;"></i><fmt:formatNumber value="${moneyUsedMap.monthlyUsedTotal }" type="number"/> <br></b> Monthly </span>
                            <em>Total</em>
                        </li>
                        <li class="stat col-md-3 col-sm-3 col-xs-6">
                            <span><b class="value"><i class="fa fa-fw fa-krw" style="font-size: 12px;"></i><fmt:formatNumber value="${moneyUsedMap.usedMax_Monthly }" type="number"/><br></b> Monthly </span>
                            <em> Top </em>
                        </li>
                        <li class="stat col-md-3 col-sm-3 col-xs-6">
                            <span><b class="value"><i class="fa fa-fw fa-krw" style="font-size: 12px;"></i><fmt:formatNumber value="${moneyUsedMap.usedMax_Total }" type="number"/></b> Total </span>
                            <em>Top </em>
                        </li>
                    </ul>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel ">
                <div class="panel-heading">
                    <h3 class="panel-title">Expenditure</h3>
                </div>
                <div class="panel-body">
