var ArkAdmin = new function($) {
    ...
    function initCharts(charts) {
        ...
        $.ajax({
        	type:"POST",
        	url:"mainChart_RevenueCardNamePrinter",
        	dataType:"JSON",
        	async:true,
        		...
        		var chartLines = {	//차트 라인 초기화
                    ...
                    chartBars = {	// bar 타입 설정
                        ...
                        xaxis: {
                        	// 아래쪽 차트, Revenue
                            ticks: [
                                [1, cardList[0]==null?'':cardList[0].cardName],
                                [2, cardList[1]==null?'':cardList[1].cardName],
                                [3, cardList[2]==null?'':cardList[2].cardName],
                                [4, cardList[3]==null?'':cardList[3].cardName],
                                [5, cardList[4]==null?'':cardList[4].cardName],
                                [6, cardList[5]==null?'':cardList[5].cardName],
                                [7, cardList[6]==null?'':cardList[6].cardName],
                                [8, cardList[7]==null?'':cardList[7].cardName],
                                [9, cardList[8]==null?'':cardList[8].cardName],
                                [10, cardList[9]==null?'':cardList[9].cardName]
                            ],
                            font: {
                                size: 12,
                                family: "Open Sans, Arial",
        ...
        /*var chartLines = {	//차트 라인 초기화
            ...
            chartBars = {	// bar 타입 설정
                ...
                xaxis: {
                	// 아래쪽 차트, Revenue
                    ticks: [
                        [1, cardList[0].cardName],
                        [2, cardList[1].cardName],
                        [3, "Mar"],
                        [4, "Apr"],
                        [5, "May"],
                        [6, "Jun"],
...
jQuery(function() {
    ...
    $.ajax({
    	type:"POST",
    	url:"mainChart_ConversionPrinter",
    	dataType:"JSON",
    	async:true,
    	success:function(data,status,jqXHR){
    		useData = data;
    	        ...
    	        charts = {
    	            "#dashboardConversions": {
    	                data: [{
    	                    ...
    	                    label: "This Year Used",
    	                    data: [
    	                         [1, useData.this_Jan-useData.last_Jan],
								 [2, useData.this_Feb-useData.last_Feb],
								 [3, useData.this_Mar-useData.last_Mar],
								 [4, useData.this_Apr-useData.last_Apr],
								 [5, useData.this_May-useData.last_May],
								 [6, useData.this_Jun-useData.last_Jun],
								 [7, useData.this_Jul-useData.last_Jul],
								 [8, useData.this_Aug-useData.last_Aug],
								 [9, useData.this_Sep-useData.last_Sep],
								 [10, useData.this_Oct-useData.last_Oct],
								 [11, useData.this_Nov-useData.last_Nov],
								 [12, useData.this_Dec-useData.last_Dec]
    	                    ]
    	                }]
    	            },
    	            "#chartZoom": {
    	            ...
    	            "#dashboardRevenues": {
    	                ...
    	                data: [{
    	                    ...
    	                    data: [
    	                        [1, useData.cardList[0]==null?0:useData.cardList[0].tot],
    	                        [2, useData.cardList[1]==null?0:useData.cardList[1].tot],
    	                        [3, useData.cardList[2]==null?0:useData.cardList[2].tot],
    	                        [4, useData.cardList[3]==null?0:useData.cardList[3].tot],
    	                        [5, useData.cardList[4]==null?0:useData.cardList[4].tot],
    	                        [6, useData.cardList[5]==null?0:useData.cardList[5].tot],
    	                        [7, useData.cardList[6]==null?0:useData.cardList[6].tot]
    	                        [8, useData.cardList[7]==null?0:useData.cardList[7].tot],
    	                        [9, useData.cardList[8]==null?0:useData.cardList[8].tot]
    	                        [10, useData.cardList[9]==null?0:useData.cardList[9].tot]
    	                        /*[5, 57523],
    	                        [6, 98432],
    	                        [7, 90934],
    	                        [8, 78932]*/
